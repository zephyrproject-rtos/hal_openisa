...
uint8_t rx_bba_dcoc_dac_trim_DCest(void)
{
    ...
    if ((bbf_dcoc_step>250) & (bbf_dcoc_step<305))
    {
        bbf_dcoc_step_rcp = (uint32_t)roundf((float)0x8000U / temp_step);
...
void force_rx_init_pulse(void)
{
    ...
    XCVR_TSM->OVRD2 = (XCVR_TSM->OVRD2 & ~XCVR_TSM_OVRD2_RX_INIT_OVRD_MASK) | XCVR_TSM_OVRD2_RX_INIT_OVRD(0);
    XCVR_TSM->OVRD2 = (XCVR_TSM->OVRD2 & ~XCVR_TSM_OVRD2_RX_INIT_OVRD_EN_MASK) | XCVR_TSM_OVRD2_RX_INIT_OVRD_EN(1);

    // Assert RX_INIT override
    XCVR_TSM->OVRD2 = (XCVR_TSM->OVRD2 & ~XCVR_TSM_OVRD2_RX_INIT_OVRD_MASK) | XCVR_TSM_OVRD2_RX_INIT_OVRD(1);
    ...
    XCVR_TSM->OVRD2 = (XCVR_TSM->OVRD2 & ~XCVR_TSM_OVRD2_RX_INIT_OVRD_EN_MASK) | XCVR_TSM_OVRD2_RX_INIT_OVRD_EN(0);
}
