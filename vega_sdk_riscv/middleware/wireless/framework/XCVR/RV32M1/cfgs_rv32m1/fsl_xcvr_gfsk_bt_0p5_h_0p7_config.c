...
const xcvr_mode_config_t gfsk_bt_0p5_h_0p7_mode_config =
{
    ...
    .phy_fsk_cfg = XCVR_PHY_PHY_FSK_CFG_AA_PLAYBACK(1) |
                   ...
                   XCVR_PHY_PHY_FSK_CFG_AA_CORR_GAIN(0x06) |
...
const xcvr_mode_datarate_config_t xcvr_GFSK_BT_0p5_h_0p7_1mbps_config =
{
    ...
    .phy_fsk_misc_mode_datarate_26mhz =
        XCVR_PHY_PHY_FSK_MISC_PD_THRESH_B(0xAD) |
    ...
    .phy_fsk_pd_cfg1_mode_datarate_26mhz = XCVR_PHY_PHY_FSK_PD_CFG1_PD_FREQ_THRESH(0x0A) |
                                           XCVR_PHY_PHY_FSK_PD_CFG1_PD_THRESH(0xAD),
    ...
    .rx_chf_coeffs_26mhz.rx_chf_coef_6 = 0xFFDE,
    .rx_chf_coeffs_26mhz.rx_chf_coef_7 = 0xFFE8,
    .rx_chf_coeffs_26mhz.rx_chf_coef_8 = 0x0009,
    ...
    .rx_chf_coeffs_32mhz.rx_chf_coef_2 = 0xFFFB,
    .rx_chf_coeffs_32mhz.rx_chf_coef_3 = 0xFFF4,
    .rx_chf_coeffs_32mhz.rx_chf_coef_4 = 0x0000,
    .rx_chf_coeffs_32mhz.rx_chf_coef_5 = 0x0019,
    .rx_chf_coeffs_32mhz.rx_chf_coef_6 = 0x0018,
    .rx_chf_coeffs_32mhz.rx_chf_coef_7 = 0xFFE7,
    .rx_chf_coeffs_32mhz.rx_chf_coef_8 = 0xFFB9,
    .rx_chf_coeffs_32mhz.rx_chf_coef_9 = 0xFFE2,
    .rx_chf_coeffs_32mhz.rx_chf_coef_10 = 0x006C,
